...
// UnityEngine.BoxCollider[]
struct BoxColliderU5BU5D_t3443516536  : public Il2CppArray
{
public:
	ALIGN_FIELD (8) BoxCollider_t2538127765 * m_Items[1];

public:
	inline BoxCollider_t2538127765 * GetAt(il2cpp_array_size_t index) const { return m_Items[index]; }
	inline BoxCollider_t2538127765 ** GetAddressAt(il2cpp_array_size_t index) { return m_Items + index; }
	inline void SetAt(il2cpp_array_size_t index, BoxCollider_t2538127765 * value)
	{
		m_Items[index] = value;
		Il2CppCodeGenWriteBarrier(m_Items + index, value);
	}
